                                    ...
                                    <div className="form-horizontal">
                                        <div className="row form-group">
                                            <div className="col-sm-6">
                                                ...
                                                <div className="col-sm-8">
                                                    <input id="inputVehicleLicense" type="text" className="form-control"
                                    ...
                                    <div className="form-horizontal">
                                        <div className="row form-group">
                                            <div className="col-sm-6">
                                                ...
                                                <div className="col-sm-8">
                                                    <input id="inputDriverFirstName" type="text" className="form-control"
                                            ...
                                            <div className="col-sm-6">
                                                ...
                                                <div className="col-sm-8">
                                                    <input id="inputDriverLastName" type="text" className="form-control"
                                        ...
                                        <span className="input-group-addon">
                                            ...
                                            <div className="col-sm-6">
                                                ...
                                                <div className="col-sm-8">
                                                    <input id="inputDriverPhone" type="text" className="form-control" ref="inputDriverPhone"/>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="row form-group">
                                            <div className="col-sm-6">
                                                ...
                                                <div className="col-sm-8">
                                                    <input id="inputDriverLicense" type="text" className="form-control"
